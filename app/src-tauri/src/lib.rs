...
use crate::commands::{
    ...
    ms_grant_quality_item, ms_health, ms_history, ms_item_catalog_apply, ms_item_catalog_check,
    ms_item_catalog_export, ms_item_catalog_revert, ms_item_catalog_status, ms_list_commands,
    ms_list_logs, ms_list_runs, ms_list_timezones, ms_player_location, ms_publish, ms_search_items,
    ms_search_journey_nodes, ms_search_players, ms_search_skill_modules, ms_search_vehicles,
    ms_search_xp_event_tags, ms_set_config, ms_set_specialization_level, ms_specialization,
    ms_trigger_run, ms_welcome_grant_retry, ms_welcome_grants, ms_welcome_whisper,
    record_operation_log, remote_component_log_tail, remote_server_components,
    ...
    uninstall_management_service, write_item_catalog_export,
};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ms_player_location,
            ms_specialization,
            ms_set_specialization_level,
            ms_grant_quality_item,
            ms_item_catalog_status,
            ms_item_catalog_check,
            ms_item_catalog_apply,
            ms_item_catalog_revert,
            ms_item_catalog_export,
